...
skip_str_case = skip("TODO: Implement yp_str.lower/swapcase/islower/etc") # FIXME Remove
...
skip_str_unicode_db = skip("TODO: Implement yp_str.isalpha/isdigit/etc") # FIXME Remove
