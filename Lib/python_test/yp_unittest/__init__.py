...
skip_str_big_chars = skip("TODO: Improve support for chars >latin-1") # FIXME Remove
...
skip_str_space = skip("TODO: Implement yp_str.expandtabs/strip/ljust/isspace/etc") # FIXME Remove
skip_str_split = skip("TODO: Implement yp_str.split/splitlines/partition/etc") # FIXME Remove
...
# .title itself documents limitations of the implementation, which makes it unlikely to be useful.
skip_string_title = skip("nohtyP does not support .title/.istitle on strings")
