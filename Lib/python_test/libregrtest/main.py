...
from python_test.libregrtest.cmdline import _parse_args
from python_test.libregrtest.runtest import (
...
from python_test.libregrtest.setup import setup_tests
from python_test.libregrtest.pgo import setup_pgo_tests
from python_test.libregrtest.utils import removepy, count, format_duration, printlist
from python_test import support
from python_test.support import os_helper
...
class Regrtest:
    ...
    def parse_args(self, kwargs):
        ...
        if worker_args is not None:
            from python_test.libregrtest.runtest_mp import parse_worker_args
    ...
    def run_tests(self):
        ...
        if self.ns.use_mp:
            from python_test.libregrtest.runtest_mp import run_tests_multiprocess
    ...
    def _main(self, tests, kwargs):
        if self.worker_test_name is not None:
            from python_test.libregrtest.runtest_mp import run_tests_worker
        ...
        if sys.platform == 'win32' and self.worker_test_name is None:
            from python_test.libregrtest.win_utils import WindowsLoadTracker
